...
var _baseGetTag = __webpack_require__(338);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(343);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(345);
...
var _root = __webpack_require__(339);
...
var _reduxWebworker = __webpack_require__(132);
...
(0, _reduxWebworker.createWorker)(function () {
...
exports.Store = exports.createWorker = undefined;

var _createWorker = __webpack_require__(133);

var _createWorker2 = _interopRequireDefault(_createWorker);

var _workerStore = __webpack_require__(336);

var _workerStore2 = _interopRequireDefault(_workerStore);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var createWorker = exports.createWorker = _createWorker2.default;
var Store = exports.Store = _workerStore2.default;
...
exports.default = function (createStore) {
  ...
  self.addEventListener('message', function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref4) {
      var data = _ref4.data;
      var id, type, payload, response;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              id = data.id, type = data.type, payload = data.payload;
              response = {
                id: id,
                payload: undefined,
                error: false
            ...
            case 6:
              response.payload = _context3.sent;
              _context3.next = 13;
              break;
            ...
            case 9:
              ...
              response.payload = _context3.t0.toString();
              response.error = true;
...
var Store = function () {
  ...
  _createClass(Store, [{
    ...
    key: 'run',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, payload) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return new Promise(function (resolve, reject) {
                  var currentId = _this2.requestId++;
                  var listener = function listener(_ref3) {
                    ...
                    if (id === currentId) {
                      ...
                      _this2.worker.removeEventListener('message', listener);
                    }
                  };
                  _this2.worker.addEventListener('message', listener);
    ...
    key: 'dispatch',
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(action) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return this.run('dispatch', action);
...
var _combineReducers = __webpack_require__(349);
...
var _getRawTag = __webpack_require__(341);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(342);
...
var _freeGlobal = __webpack_require__(340);
...
var _overArg = __webpack_require__(344);
...
/***/ })
/******/ ]);
//# sourceMappingURL=1eb9bea7f66533bd1e7e.worker.js.map